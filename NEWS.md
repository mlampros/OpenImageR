...
I did OpenMP optional for all cpp files due to fact that the OSX OS does not currently support openMP ( r-devel-osx-x86_64-clang )
...
I can not fix the following error in the hog_features.cpp file for the r-oldrel-windows platform as it is GCC specific,

* error: could not convert '{{-0x00000000000000001, 0, 1}, {-0x00000000000000002, 0, 2}, {-0x00000000000000001, 0, 1}}' from '<brace-enclosed initializer list>' to 'arma::mat {aka arma::Mat<double>}'

Platforms, which support newer versions of GCC (GCC >= 4.9.0) do not throw such an error.
