...
In this vignette, I'll explain the new functionality of the OpenImageR package, [SLIC and SLICO superpixels](https://www.epfl.ch/labs/ivrl/research/slic-superpixels/) (Simple Linear Iterative Clustering) and their applicability based on [an IJSR article](https://www.ijsr.net/archive/v4i4/SUB152869.pdf). The author of the article uses superpixel (SLIC) and Clustering (Affinity Propagation) to perform image segmentation (the article was reproduced using the latest versions of the [OpenImageR](https://github.com/mlampros/OpenImageR) and [ClusterR](https://github.com/mlampros/ClusterR) packages).
...
The [author of the article](https://www.ijsr.net/archive/v4i4/SUB152869.pdf), that I mentioned earlier, uses a method named **SLICAP** (SLIC + AP) to perform image segmentation. The methodology is the following:
...
* [Image Segmentation using SLIC Superpixels and Affinity Propagation Clustering, Bao Zhou, 2013](https://www.ijsr.net/archive/v4i4/SUB152869.pdf)
